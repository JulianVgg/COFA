...
function Navbar() {
 ...
 const facebookUrl = isDispensario
  ...
  : 'https://www.facebook.com/COFAXelayDispensario/?locale=es_LA'
  const whatsappUrl = isDispensario
    ...
    <header className="site-header">
      <div className="nav-shell">
        <Link to={isDispensario ? '/dispensario' : '/'} className="brand">
          <div className="brand-logo-box">
            <img
              ...
              alt={isDispensario ? 'Logo del Dispensario' : 'Logo de COFA'}
          ...
          <div className="brand-copy">
            ...
            <p className="brand-script">
              {isDispensario ? 'Salud y servicio' : 'COFA'}
            </p>
          </div>
        </Link>
        ...
        <nav className="main-nav">
          {isDispensario ? (
            <>
              <a href="/dispensario#dispensario-ubicacion">Ubicacion</a>
              ...
              <div className="nav-dropdown">
                ...
                <div className="nav-dropdown-menu">
                  ...
                  <Link to="/dispensario/servicios/enfermeria">Enfermeria</Link>
                </div>
              </div>
