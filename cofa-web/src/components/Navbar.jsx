      ...
      <div className="nav-shell">
        ...
        <nav className="main-nav">
          ...
          <div className="nav-socials">
            <a
              href="https://www.facebook.com/COFAXelayDispensario/?locale=es_LA"
              target="_blank"
              rel="noreferrer"
              className="nav-social-btn"
              aria-label="Facebook de COFA"
              title="Facebook de COFA"
            >
            ...
            <a
              ...
              rel="noreferrer"
              className="nav-social-btn"
              aria-label="WhatsApp de COFA"
              title="WhatsApp de COFA"
            >
